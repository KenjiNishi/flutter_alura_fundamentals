...
class _ContactsListState extends State<ContactsList> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: buildAddActionButton(context),
    );
  }

  FloatingActionButton buildAddActionButton(BuildContext context) {
  ...
  void update(BuildContext context) =>
      context.read<ContactsListCubit>().reload(widget.dao);
}
